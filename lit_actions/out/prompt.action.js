...
(() => {
  ...
  function callAgentForPrompt(agentEndpoint, idea, digest, prompt) {
    return __async(this, null, function* () {
      return yield callAgent({ agentEndpoint, idea, digest, action: "prompt", prompt });
    });
  }

  // lit_actions/src/prompt.action.ts
  (() => __async(void 0, null, function* () {
    ...
    const agentResult = yield callAgentForPrompt(agentEndpoint, idea, decryptedDigest, prompt);
